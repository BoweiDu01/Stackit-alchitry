...
set_property PACKAGE_PIN M2 [get_ports {externalbutton}]
set_property IOSTANDARD LVCMOS33 [get_ports {externalbutton}]
set_property PULLDOWN true [get_ports {externalbutton}]
